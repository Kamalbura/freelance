          ...
          <div className="lg:col-span-1">
            ...
            >
              ...
              <p className="text-slate-400 text-sm mb-6 leading-relaxed">
                Transforming innovative ideas into cutting-edge IoT solutions. 
                Specializing in ESP32 development, embedded systems, and connected device solutions.
              </p>
            ...
            >
              ...
              <div className="mt-6">
                ...
                <div className="flex">
                  ...
                  />
                  <button className="px-4 py-2 bg-primary-600 hover:bg-primary-700 rounded-r-lg text-sm font-medium transition-colors duration-200">
                    Subscribe
                  </button>
                </div>
              </div>
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-slate-400 text-sm">
              © {currentYear} IoT Development Expert. All rights reserved.
            </p>
